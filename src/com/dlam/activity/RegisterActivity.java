...
public class RegisterActivity extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.register_complete:
			...
			userAPwd = et_apwd.getText().toString().trim();
			...
			if (TextUtils.isEmpty(userName)) {
				...
				et_pwd.requestFocus();
				return;
			} else if (TextUtils.isEmpty(userAPwd)) {
				Toast.makeText(this, getResources().getString(R.string.Confirm_password_cannot_be_empty), Toast.LENGTH_SHORT).show();
				et_apwd.requestFocus();
				return;
			} else if (!userPwd.equals(userAPwd)) {
			...
			if (!TextUtils.isEmpty(userName) && !TextUtils.isEmpty(userPwd)) {
				...
				pd.show();
				registerCompany(userName, userPwd, pin);
	 ...
	 * 公司服务器注册
	 */
	public void registerCompany(String phonenum,String password,String pin)
	{
