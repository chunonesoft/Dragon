...
public class LoginActivity extends BaseActivity implements OnClickListener{
					...
					public void onSuccess(LoginBean responce) {
						if(responce.getRetcode().equals("1"))
						{
							...
							*/	
							...
							initData();
							login(responce.getUserid().toString(),et_pwd.getText().toString());
							loadDialog.cancel();
						}
						else
						{
	...
	public void login(String userid,String userpassword) {
		...
		// 调用sdk登陆方法登陆聊天服务器，在这里登陆聊天服务器
		EMChatManager.getInstance().login(userid, userpassword, new EMCallBack() {
